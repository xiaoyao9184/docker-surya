...
**NOTE**:
> Starting from Surya `0.20.0`, commit-based image tags use the short commit id of this project repository.
> Before Surya `0.20.0`, commit-based image tags used the short commit id of the upstream Surya project repository.
...
For example, a Surya Git tag `v0.21.0` will publish `${DOCKERHUB_USERNAME}/surya:0.21.0`.
